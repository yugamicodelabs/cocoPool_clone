...
export const signup = params => (dispatch, getState, sdk) => {
  ...
  const { email, password, firstName, lastName, phoneNumber, discoveredServiceVia, whatToDo, ...rest } = params;
  const publicData = {
    phoneNumber,
    userType: whatToDo
  }
  ...
  const createUserParams = isEmpty(rest)
    ...
    : { email, password, firstName, lastName, publicData, privateData, protectedData: { phoneNumber, ...rest } };
